package com.afeka.survivalgame;
...
public class Activity_Game extends AppCompatActivity {
    ...
    //Ram: For my ID number the steps are : (Left to Right)
    // ^ < v v < v > < v = win
    ...
    private void finishGame() {
        ...
        if (this.goodToGo) {
            //Bug found : duration was 1 after decompiling, changed it back to Toast duration ENUM
